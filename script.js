...
const pickTask = function () {
  ...
  //
  document.querySelector('.message h3').textContent = `selecciono la tarea ${taskName.value}`;
  ...
  document.getElementsByClassName("message")[0].style.backgroundColor = tasks[random].color;
